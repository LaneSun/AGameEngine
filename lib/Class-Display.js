...
export class Display {
    ...
    init(canvas) {
        ...
        this.Gui.init();
        // Gui.add(2, new AGE_Gui.Gui_Text_Block(3,50,100,800,`Hello, nice to meet you.
// welcome!!
// This is a test text, you are free to edit the width of the text !`));
        // Gui.add(1, new AGE_Gui.Gui_Rect(50,100,800,1000));
    }
    loop() {
        if (!this.paused) {
            this.clear();
